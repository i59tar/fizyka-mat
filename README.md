...
# 7. Laser - schemat wzbudzeń - rezonator

# 8. Fale de Broglie - fale materii

https://www.youtube.com/watch?v=ZqspDsQSZuI  (en)

http://theory.uwinnipeg.ca/physics/quant/node6.html (tekst, en)

# 9. Fale de Broglie - przykład. Długość fali elektronu przyspieszonego w mikroskopie polem 500 kV

Wzór: lambda(dł. fali) = h(st. Plancka) / mv(pęd cząstki)
https://www.youtube.com/watch?v=XvId0wsEk9E  (en)
...
# 14. Równania opisujące i wiążące mechanikę i elektromagnetyzm w fizyce klasycznej

# 15. Założenia dla równań i funkcji opisujących stany sizyczne układów atomowych i cząsteczkowych

# 16. Stacjonarne równanie Schrodingera dla przypadku:
	# V(x)=0 »przypadek z metalem
	# V(x)=dół 0, brzeg inf
	# V(x)=1/R » atom wodoru
	# V(x)=potencjał periodyczny 0,a

# 17. Metal - elektrony w metalu, przewodnictwo w metalu, prawo Ohma

# 18. Model półprzewodnika:
	# 1. Przykład sieci i strefy Brillouina
	# 2. Przykłady struktury pasmowej Kroniga-Penneya
	# 3. Masa efektywna, przewodnictwo, poziom Fermiego
	# 4. Półprzewodnik samoistny, półprzewodnik domieszkowany

# 19. Elektronika ciał stałych - złącze typu p-n, charakterystyka pasmowa i I(V)
...
# 25. Model rozszczepienia, reaktor jądrowy

# 26. Nadprzewodnictwo - kiedy występuje
